        ...
        <section className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 gap-6 mt-12 md:grid-cols-2 lg:grid-cols-3">
            {nationalParks.map((park) => (
              <article
                key={park.name}
                className="overflow-hidden rounded-3xl border border-[#e9eee3] bg-white shadow-sm transition-shadow duration-300 hover:shadow-xl"
              >
                <div className="relative w-full h-40 sm:h-44">
                  <img src={park.image} alt={park.name} className="object-cover w-full h-full" />
                  <div className="absolute inset-0 bg-black/35" />
                  <div className="absolute inline-flex items-center justify-center w-10 h-10 text-white left-4 top-4 rounded-xl bg-gir-green/90">
                ...
                <div className="p-5 sm:p-6">
                  ...
                  <div className="mt-4 space-y-3 text-sm text-gray-700">
                    <div className="flex items-center gap-2">
                      <MapPin className="w-4 h-4 text-gir-green" />
                      <span className="font-medium">{park.state}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Clock3 className="w-4 h-4 text-gir-green" />
                      <span>{park.bestSeason}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Ticket className="w-4 h-4 text-gir-green" />
                      <span>{park.fee}</span>
                    </div>
                  </div>
                  ...
                  <Link
                    to="/safari"
                    className="mt-5 inline-flex w-full items-center justify-center rounded-xl bg-gir-green px-5 py-2.5 font-semibold text-white transition-opacity duration-300 hover:opacity-90"
                  >
                    Book Now
                  </Link>
                </div>
